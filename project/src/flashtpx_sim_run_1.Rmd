---
title: 'flashtpx: Simulation Run 1'
...
This is the first simulation run of *flashtpx* without the non-negative constraint. The main idea is to try and replicate the results for the `FitGoM()` in CountClust or `topics()` model in the maptpx package due to Matt Taddy.
...
f = g5$f
res = res - l%*%t(f)
g6 = suppressMessages(flash(res,sigmae2_true = lambda))
l = g6$l
f = g6$f
par(mfrow = c(2, 2))
par(cex = 0.6)
